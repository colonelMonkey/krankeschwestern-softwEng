...
\par
    ...
    \begin{tabular}[m]{|m{7cm}|m{9cm}|}
        ...
        Auslösendes Ereignis & Mausklick auf den "Laden- Button"\\
        \hline
        Nachbedingung Erfolgt & Öffnen des Java- Swing- Fensters mit Filechooser zum öffnen einer Datei um ein geispeichertes Spielfeld zu laden.\\
        \hline
...
%Realisierbar? Falls nicht- rausnehmen.
...
%Rausnehmen oder entsprechend anpassen. Zweiters nach Herr Düntgens Kommentar.
...
\\
 ...
 Simulation & Dynamische Abbildung, meist realer Sachverhalte, anhand eines Modells, durch Anwendung des Modells über Zeit.\\
  ...
  \hline
  Multithreading & Muss neu definiert werden nach Herrn Düntgen.\\
 \hline
 ...
 \hline
 Spielfeldeditor & Hierüber wird das 2D Feld auf eine gewünschte Größe abgegrenzt.
 \hline
 Regeleditor &
 \hline
