...
\hline
Erwartetes Ergebnis&Einfügen Modus wird Gestartet und ermoglicht einfügen von 0.\\
\hline
\end{longtable}
...
\begin{longtable}[m]{|m{3cm}|m{10cm}|}
\hline
Ablauf&Bei Standard Spielfeld Größe, Game of Life Regelsatz, Einer Glidergun auf dem Spielfeld und ohne Verzögerung Simulation starten und eine Stunde Laufen lassen.\\
\hline
...
\hline
Erwartetes Ergebnis&Nach einer Stunde läuft das Programm noch stabil und ist nicht zwischendurch abgestürtzt.\\
\hline
\end{longtable}
